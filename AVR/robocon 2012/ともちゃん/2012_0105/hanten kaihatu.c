...
#define r_left3  PINC&_BV(6)
#define r_left2  PINC&_BV(5)
#define r_left1  PINC&_BV(4)
#define r_center  PINC&_BV(3)
#define r_right1  PINC&_BV(2)
#define r_right2  PINC&_BV(1)
#define r_right3  PINC&_BV(0)
...
void lt_back(){
		if(r_center){
			_delay_ms(5);
			if(r_center) r_straight(0xff/2);
		}

		if(r_right2){
			_delay_ms(3);
			if(r_right2) r_turn_right(0xff-20);
		}
		else if(r_left2){
			_delay_ms(3);
			if(r_left2) r_turn_left(0xff20);
		}
		else if(r_right1){
			_delay_ms(1);
			if(r_right1) r_turn_right(0xef-20);
		}
		else if(r_left1){
			_delay_ms(1);
			if(r_left1) r_turn_left(0xef-20);
		}
		else if(r_center){
			_delay_ms(3);
			if(r_center) r_straight(0xff-20);
		}
