...
void lt_straight(){
		...
		if(f_right2){
			...
			_delay_ms(1);
			if(f_right1) turn_right(0xf0-20);
		}
		else if(f_left1){
			_delay_ms(1);
			if(f_left1) turn_left(0xf0-20);
		}
		else if(f_center){
			_delay_ms(3);
...
void lift(int u,int d){
	//TCCR1A = 0b10100011;  // OCR1A OCR1B の設定
	//TCCR1B = 0b00000010;
