...
int img_boad1(){//仮想ライントレース基板
	if(f_right3){
		if(f_right3) return 6;
	}
	if(f_right3 && f_right2){
		if(f_right3 && f_right2) return 5;
	}
	else if(f_right2){
		if(f_right2) return 4;
	}
	else if(f_right2 && f_right1){
		if(f_right2 && f_right1) return 3;
	}
	else if(f_right1){
		if(f_right1) return 2;
	}
	else if(f_right1 && f_center){
		if(f_right1 && f_center) return 1;
	}
	else if(f_center){
		if(f_center) return 0;
	}
	else if(f_left1	&& f_center){
		if(f_left1	&& f_center) return -1;
	}
	else if(f_left1){
		if(f_left1) return -2;
	}
	else if(f_left2 && f_left1){
		if(f_left2 && f_left1) return -3;
	}
	else if(f_left2){
		if(f_left2) return -4;
	}
	else if(f_left3 && f_left2){
		if(f_left3 && f_left2) return -5;
	}
	else if(f_left3){
		if(f_left3) return -6;
	}
...
int img_boad2(){//仮想ライントレース基板
	if(r_right3){
		if(r_right3) return 6;
	}
	if(r_right3 && r_right2){
		if(r_right3 && r_right2) return 5;
	}
	else if(r_right2){
		if(r_right2) return 4;
	}
	else if(r_right2 && r_right1){
		if(r_right2 && r_right1) return 3;
	}
	else if(r_right1){
		if(r_right1) return 2;
	}
	else if(r_right1 && r_center){
		if(r_right1 && r_center) return 1;
	}
	else if(r_center){
		if(r_center) return 0;
	}
	else if(r_left1	&& r_center){
		if(r_left1	&& r_center) return -1;
	}
	else if(r_left1){
		if(r_left1) return -2;
	}
	else if(r_left2 && r_left1){
		if(r_left2 && r_left1) return -3;
	}
	else if(r_left2){
		if(r_left2) return -4;
	}
	else if(r_left3 && r_left2){
		if(r_left3 && r_left2) return -5;
	}
	else if(r_left3){
		if(r_left3) return -6;
	}
...
void r_turn_right10(int s){
	motor_R(0,s);
	motor_L(0,s-64);
}

void r_turn_right11(int s){
	motor_R(0,s);
	motor_L(0,s-72);
}

void r_turn_right12(int s){
	motor_R(0,s);
	motor_L(0,s-80);
}

void r_turn_right13(int s){
	motor_R(0,s);
	motor_L(0,s-90);
}

void r_turn_right14(int s){
	motor_R(0,s);
	motor_L(0,s-100);
}

void r_turn_right15(int s){
	motor_R(0,s);
	motor_L(0,s-110);
}

void r_turn_right16(int s){
	motor_R(0,s);
	motor_L(0,s-120);
}

void r_turn_right17(int s){
	motor_R(0,s);
	motor_L(0,s-130);
}

void r_turn_right18(int s){
	motor_R(0,s);
	motor_L(0,s-140);
}
...
void r_turn_left10(int s){
	motor_R(0,s-64);
	motor_L(0,s);
}

void r_turn_left11(int s){
	motor_R(0,s-72);
	motor_L(0,s);
}

void r_turn_left12(int s){
	motor_R(0,s-80);
	motor_L(0,s);
}
void r_turn_left13(int s){
	motor_R(0,s-90);
	motor_L(0,s);
}

void r_turn_left14(int s){
	motor_R(0,s-100);
	motor_L(0,s);
}

void r_turn_left15(int s){
	motor_R(0,s-110);
	motor_L(0,s);
}
void r_turn_left16(int s){
	motor_R(0,s-120);
	motor_L(0,s);
}

void r_turn_left17(int s){
	motor_R(0,s-130);
	motor_L(0,s);
}

void r_turn_left18(int s){
	motor_R(0,s-140);
	motor_L(0,s);
}
