...
void lt_left(int c,int t){
	...
	while(1){
		if(c == cnt)break;
		while(1){
			if((f_right3 > 300) || (f_left3 > 300) || (f_right2 > 300) || (f_left2 > 300) || (f_left3 > 300)){
				break;
			}
		}
		while(1){
			if((f_right3 > 300) || (f_left3 > 300) || (f_right2 > 300) || (f_left2 > 300) || (f_left3 > 300))break;
		}
		c++;
	}
	leg_stop();
...
void lt_right(int c){
	...
	while(cnt <= c){
		roll_right(s);
		_delay_ms(600);
		while((r_right2) < 300) roll_right(s);
		leg_stop();
		_delay_ms(70);
		if(cnt == c){
			while((r_right1 > 300) || (r_right2 > 300)) roll_right(0xa0);
			while((r_left1 > 300) || (r_left2 > 300)) roll_left(0xa0);
		}
		cnt++;
	}
	leg_stop();
