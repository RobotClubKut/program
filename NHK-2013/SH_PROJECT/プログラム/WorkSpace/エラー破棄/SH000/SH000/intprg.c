...
signed int pws0,pws1;


extern void intprg_rxi1(void);
extern PRPM0,PRPM1,PRPS0;
extern RPS0,RPS1;
extern EN0,EO0,IP0;
extern double PID0;
extern CMT0F;
...
#define	MD0ALS MTU20.TIOR.BIT.IOA     //ÉmÅ[É}Éã2 1or6
...
void INT_MTU2_5_TGIW5(void){/* sleep(); */
	...
	IP0+=EN0;
//	PID0=(double)PRPS0*0.6+0.10*IP0+0.002*(EN0-EO0);
...
/*
	...
	if(MTU20.TGRA==2500)
		MTU20.TGRA-=1;
	if(MTU20.TGRA==0){
		MTU20.TIOR.BIT.IOA = 1;     //í‚é~
		MTU20.TIOR.BIT.IOB = 1;     //í‚é~	

//	}else if(MTU20.TGRA==50000){
//		MTU20.TIOR.BIT.IOA = 6;     //í‚é~
		/////
	}else{
		MTU20.TIOR.BIT.IOA = 2;     //èâä˙èÛë‘Ç≈0èoóÕ ÉRÉìÉyÉAÉ}ÉbÉ`ÇµÇΩÇÁ1èoóÕ
		MTU20.TIOR.BIT.IOB = 2;     //èâä˙èÛë‘Ç≈0èoóÕ ÉRÉìÉyÉAÉ}ÉbÉ`ÇµÇΩÇÁ1èoóÕ	
	}
*/	
	
	MTU25.TSR.BIT.CMFW = 0;		//ÔøΩtÔøΩÔøΩÔøΩOÔøΩNÔøΩÔøΩÔøΩA
...
*/
	AD0.ADCR.BIT.ADST=1;//ADÉXÉ^Å[Ég
