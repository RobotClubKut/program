...
static volatile l_u8  LIN_1_Buffer_Frame1[1u] = {0xFBu};
static volatile l_u8  LIN_1_Buffer_seesaw_motor[1u] = {0x00u};
...
l_u8 l_u8_rd(l_signal_handle sss) 
{
    ...
    switch(sss)
    {
        case seesaw_motor_status_SIGNAL_HANDLE:
            returnValue = l_u8_rd_seesaw_motor_status();
        break;
...
/*******************************************************************************
* Function Name: l_u8_rd_seesaw_motor_status
********************************************************************************
*
* Summary:
*  Reads and returns the current value of the signal for signals of the size
...
l_u8 l_u8_rd_seesaw_motor_status(void) 
{
    ...
    return(LIN_1_Buffer_seesaw_motor[LIN_1_seesaw_motor_status_seesaw_motor_SIG_BYTE_OFFSET]);
}
...
l_bool l_flg_tst(l_flag_handle fff)
{
    ...
    switch(fff)
    {
        case seesaw_motor_status_FLAG_HANDLE:
            returnValue = l_flg_tst_seesaw_motor_status();
        break;
        ...
        case seesaw_motor_FLAG_HANDLE:
            returnValue = l_flg_tst_seesaw_motor();
        break;
...
/*******************************************************************************
* Function Name: l_flg_tst_seesaw_motor_status
********************************************************************************
*
* Summary:
*  Returns a C boolean indicating the current state of the flag specified by
...
l_bool l_flg_tst_seesaw_motor_status(void)
{
    ...
    if(0u != (LIN_1_statusFlagArray[LIN_1_seesaw_motor_status_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_seesaw_motor_status_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
/*******************************************************************************
* Function Name: l_flg_tst_seesaw_motor
********************************************************************************
*
* Summary:
*  Returns a C boolean indicating the current state of the flag specified by
...
l_bool l_flg_tst_seesaw_motor(void)
{
    ...
    if(0u != (LIN_1_statusFlagArray[LIN_1_seesaw_motor_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_seesaw_motor_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
/*******************************************************************************
* Function Name: l_flg_clr_seesaw_motor_status
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
{
    LIN_1_statusFlagArray[LIN_1_seesaw_motor_status_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_seesaw_motor_status_FRAME_FLAG_MASK_0);
}
...
/*******************************************************************************
* Function Name: l_flg_clr_seesaw_motor
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
{
    LIN_1_statusFlagArray[LIN_1_seesaw_motor_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_seesaw_motor_FRAME_FLAG_MASK_0);
}
    ...
    static LIN_1_PID_INFO_TABLE const CYCODE LIN_1_pidInfoTable[LIN_1_NUM_FRAMES] =
{
    ...
    {(LIN_1_FRAME_DIR_SUBSCRIBE | LIN_1_FRAME_DATA_SIZE_1 | LIN_1_FRAME_TYPE_UNCOND),
     LIN_1_Buffer_seesaw_motor}
};
...
static void LIN_1_SetAssociatedFlags(l_u8 pIndex)
{
    switch(pIndex)
    {
        ...
        case 1u:
            /* Mark frame "seesaw_motor" (Type:Unconditional,Associated With:None) and associated signals processed. */ 
            LIN_1_statusFlagArray[LIN_1_ISR_AUX_SET_FLAGS_seesaw_motor_FLAG_BYTE_OFFSET_0] |=
                LIN_1_ISR_AUX_SET_FLAGS_seesaw_motor_FLAG_MASK_0;
        break;
