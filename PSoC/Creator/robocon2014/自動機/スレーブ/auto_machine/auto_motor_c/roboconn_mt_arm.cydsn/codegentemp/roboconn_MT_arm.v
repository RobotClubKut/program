...
module top ;
	...
	wire [0:0] tmpOE__Motor_1_r_net;
	wire [0:0] tmpFB_0__Motor_1_r_net;
	wire [0:0] tmpIO_0__Motor_1_r_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_r_net;
	electrical [0:0] tmpSIOVREF__Motor_1_r_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		Motor_1_r
		 (.oe(tmpOE__Motor_1_r_net),
		  .y({Net_41}),
		  .fb({tmpFB_0__Motor_1_r_net[0:0]}),
		  .io({tmpIO_0__Motor_1_r_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_r_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_r_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_r_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_1_l_net;
	wire [0:0] tmpFB_0__Motor_1_l_net;
	wire [0:0] tmpIO_0__Motor_1_l_net;
	wire [0:0] tmpINTERRUPT_0__Motor_1_l_net;
	electrical [0:0] tmpSIOVREF__Motor_1_l_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2b313cf3-fb8b-4d7c-aa78-335009f37428"),
		  ...
		  .width(1))
		Motor_1_l
		 (.oe(tmpOE__Motor_1_l_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__Motor_1_l_net[0:0]}),
		  .io({tmpIO_0__Motor_1_l_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_1_l_net),
		  .interrupt({tmpINTERRUPT_0__Motor_1_l_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_1_l_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_r_net;
	wire [0:0] tmpFB_0__Motor_2_r_net;
	wire [0:0] tmpIO_0__Motor_2_r_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_r_net;
	electrical [0:0] tmpSIOVREF__Motor_2_r_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fb47b41e-d11d-40fb-8bce-3099a3c620d0"),
		  ...
		  .width(1))
		Motor_2_r
		 (.oe(tmpOE__Motor_2_r_net),
		  .y({Net_43}),
		  .fb({tmpFB_0__Motor_2_r_net[0:0]}),
		  .io({tmpIO_0__Motor_2_r_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_r_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_r_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_r_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_2_l_net;
	wire [0:0] tmpFB_0__Motor_2_l_net;
	wire [0:0] tmpIO_0__Motor_2_l_net;
	wire [0:0] tmpINTERRUPT_0__Motor_2_l_net;
	electrical [0:0] tmpSIOVREF__Motor_2_l_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0a223011-cba9-4e4e-8011-d44e37234e9c"),
		  ...
		  .width(1))
		Motor_2_l
		 (.oe(tmpOE__Motor_2_l_net),
		  .y({Net_44}),
		  .fb({tmpFB_0__Motor_2_l_net[0:0]}),
		  .io({tmpIO_0__Motor_2_l_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_2_l_net),
		  .interrupt({tmpINTERRUPT_0__Motor_2_l_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_2_l_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    ADC_DelSig_v3_0_5 ADC_DelSig_1 (
        .vplus(Net_210),
        .vminus(Net_219),
        .soc(1'b1),
        .eoc(Net_221),
