...
static volatile l_u8  LIN_1_Buffer_Frame2[1u] = {0x3Fu};
...
l_u8 l_u8_rd(l_signal_handle sss) 
{
    ...
    switch(sss)
    {
        case arm_SIGNAL_HANDLE:
            returnValue = l_u8_rd_arm();
        break;
...
*
*******************************************************************************/
l_u8 l_u8_rd_arm(void) 
{
    /* Get one byte signal from the LSB, shift for correction and mask off unnecessary bit */
    return((LIN_1_Buffer_Frame2[LIN_1_arm_Frame2_SIG_BYTE_OFFSET] & ((l_u8) ~LIN_1_arm_Frame2_SIG_MASK_0)) >>
                LIN_1_arm_Frame2_SIG_BIT_SHIFT);
}
...
l_bool l_flg_tst(l_flag_handle fff)
{
    ...
    switch(fff)
    {
        case arm_FLAG_HANDLE:
            returnValue = l_flg_tst_arm();
        break;
...
*
*******************************************************************************/
l_bool l_flg_tst_arm(void)
{
    l_bool result = LIN_1_FALSE;

    if(0u != (LIN_1_statusFlagArray[LIN_1_arm_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_arm_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
*
*******************************************************************************/
void l_flg_clr_arm(void)
{
    LIN_1_statusFlagArray[LIN_1_arm_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_arm_FRAME_FLAG_MASK_0);
}
