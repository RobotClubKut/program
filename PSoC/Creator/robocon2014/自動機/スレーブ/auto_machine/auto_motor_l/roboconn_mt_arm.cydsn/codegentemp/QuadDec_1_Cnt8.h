 ...
 *************************************/
    ...
    ********************************/
    ...
    #define QuadDec_1_Cnt8_STATUS               (* (reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define QuadDec_1_Cnt8_STATUS_PTR           (  (reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define QuadDec_1_Cnt8_STATUS_MASK          (* (reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__MASK_REG )
    #define QuadDec_1_Cnt8_STATUS_MASK_PTR      (  (reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__MASK_REG )
    #define QuadDec_1_Cnt8_STATUS_AUX_CTRL      (*(reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define QuadDec_1_Cnt8_STATUS_AUX_CTRL_PTR  ( (reg8 *) QuadDec_1_Cnt8_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define QuadDec_1_Cnt8_CONTROL              (* (reg8 *) QuadDec_1_Cnt8_CounterUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
    #define QuadDec_1_Cnt8_CONTROL_PTR          (  (reg8 *) QuadDec_1_Cnt8_CounterUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
