// ======================================================================
// roboconn_MT_arm.v generated from TopDesign.cysch
// 01/14/2014 at 05:35
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bLIN_v1_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bLIN_v1_30\bLIN_v1_30.v"
`endif
...
// LIN_v1_30(AutoBaudRateSync=true, AutoErrorSignal=true, BaudRate=19200, BreakThreshold=11, BusInactivityEnabled=true, BusInactivityThreshold=7000, CsEnabled=false, CsFunctionId=65534, CsSupplierId=32766, CsVariant=0, CtlModeReplacementString=SyncCtl, Frames=<?xml version="1.0" encoding="us-ascii"?><ArrayOfCyFrameInfo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><CyFrameInfo Index="1" Name="Frame1" DefaultID="1" MessageID="1" Direction="Publish" Length="1" Type="Unconditional" Association="None" /><CyFrameInfo Index="2" Name="Frame2" DefaultID="2" MessageID="0" Direction="Subscribe" Length="3" Type="Unconditional" Association="None" /></ArrayOfCyFrameInfo>, Lin20=false, SaeJ2602=false, Services01=128, Signals=<?xml version="1.0" encoding="us-ascii"?><ArrayOfCySignalInfo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><CySignalInfo FrameID="-1" SignalName="limit" StartingIndex="0" Length="1" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo><CySignalInfo FrameID="1" SignalName="Response_Error" StartingIndex="1" Length="1" Type="SCALAR" Attribute="RESPONSE_ERROR" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="MS UI Gothic, 9pt" NameColor="-1" /></CySignalInfo><CySignalInfo FrameID="2" SignalName="motor_data" StartingIndex="8" Length="8" Type="SCALAR" Attribute="USER_SIGNAL" Locked="false" Description="" DefaultValue="0"><Appearance FillColor="-7876885" NameFont="Microsoft Sans Serif, 9pt, style=Bold" NameColor="-16777088" /></CySignalInfo></ArrayOfCySignalInfo>, TlApiFormat=true, TlBufLenMax=512, TlBufLenRx=32, TlBufLenTx=32, TlEnabled=false, TlInitialNad=1, Transparency=80, CY_COMPONENT_NAME=LIN_v1_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=LIN_1, CY_INSTANCE_SHORT_NAME=LIN_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=LIN_1, )
module LIN_v1_30_3 (
    rxd,
    txd,
    auxClk);
...
// QuadDec_v2_30(Counter8bit=true, CounterResolution=1, CounterSize=8, CounterSizeReplacementString=int8, CounterSizeReplacementStringUnsigned=uint8, TypeCastReplacementString=int16, UsingGlitchFiltering=true, UsingIndexInput=true, CY_COMPONENT_NAME=QuadDec_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=QuadDec_1, CY_INSTANCE_SHORT_NAME=QuadDec_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=QuadDec_1, )
module QuadDec_v2_30_6 (
    quad_A,
    quad_B,
    index,
    clock,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2b313cf3-fb8b-4d7c-aa78-335009f37428"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fb47b41e-d11d-40fb-8bce-3099a3c620d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0a223011-cba9-4e4e-8011-d44e37234e9c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Position_1_net;
	wire [0:0] tmpFB_0__Position_1_net;
	wire [0:0] tmpIO_0__Position_1_net;
	wire [0:0] tmpINTERRUPT_0__Position_1_net;
	electrical [0:0] tmpSIOVREF__Position_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .width(1))
		Position_1
		 (.oe(tmpOE__Position_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Position_1_net[0:0]}),
		  .analog({Net_210}),
		  .io({tmpIO_0__Position_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Position_1_net),
		  .interrupt({tmpINTERRUPT_0__Position_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Position_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("93a65404-c300-4bcd-9946-b9b575069b39"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b4c55e76-54e6-4c4c-a2e9-616d29c3fa26"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cce37968-d440-4fbe-8064-6807665d2ce2"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__rori_A_net;
	wire [0:0] tmpIO_0__rori_A_net;
	wire [0:0] tmpINTERRUPT_0__rori_A_net;
	electrical [0:0] tmpSIOVREF__rori_A_net;

	cy_psoc3_pins_v1_10
		#(.id("edf14738-e460-41d5-8819-2479174ebf7b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		rori_A
		 (.oe(tmpOE__rori_A_net),
		  .y({1'b0}),
		  .fb({Net_196}),
		  .io({tmpIO_0__rori_A_net[0:0]}),
		  .siovref(tmpSIOVREF__rori_A_net),
		  .interrupt({tmpINTERRUPT_0__rori_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rori_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__rori_B_net;
	wire [0:0] tmpIO_0__rori_B_net;
	wire [0:0] tmpINTERRUPT_0__rori_B_net;
	electrical [0:0] tmpSIOVREF__rori_B_net;

	cy_psoc3_pins_v1_10
		#(.id("36cccb0b-2e25-4f0e-a5db-472d3eee025a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		rori_B
		 (.oe(tmpOE__rori_B_net),
		  .y({1'b0}),
		  .fb({Net_197}),
		  .io({tmpIO_0__rori_B_net[0:0]}),
		  .siovref(tmpSIOVREF__rori_B_net),
		  .interrupt({tmpINTERRUPT_0__rori_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rori_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__rori_i_net;
	wire [0:0] tmpIO_0__rori_i_net;
	wire [0:0] tmpINTERRUPT_0__rori_i_net;
	electrical [0:0] tmpSIOVREF__rori_i_net;

	cy_psoc3_pins_v1_10
		#(.id("a332d197-9165-4378-9547-11ab8b3c031a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		rori_i
		 (.oe(tmpOE__rori_i_net),
		  .y({1'b0}),
		  .fb({Net_198}),
		  .io({tmpIO_0__rori_i_net[0:0]}),
		  .siovref(tmpSIOVREF__rori_i_net),
		  .interrupt({tmpINTERRUPT_0__rori_i_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rori_i_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
