...
/* Constants for l_u8_rd_arm */
#define LIN_1_arm_Frame2_SIG_BYTE_OFFSET    (0x00u)
#define LIN_1_arm_Frame2_SIG_BIT_SHIFT      (0x00u)
#define LIN_1_arm_Frame2_SIG_MASK_0         (0xFCu)


/* l_flg_tst_arm() and l_flg_clr_arm() */
#define LIN_1_arm_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_arm_FRAME_FLAG_MASK_0           (0x01u)
...
#define arm_SIGNAL_HANDLE        (0x01u)



#define arm_FLAG_HANDLE        (0x00u)
