...
#define LIN_1_Response_Error_Frame1_SIG_BIT_OFFSET     (0x01u)
#define LIN_1_Response_Error_Frame1_SIG_MASK_0         (0x02u)

/* Constants for l_u8_rd_motor_data */
#define LIN_1_motor_data_Frame2_SIG_BYTE_OFFSET    (0x01u)
...
#define LIN_1_Frame2_FRAME_FLAG_MASK_0           (0x04u)




#define limit_SIGNAL_HANDLE        (0x00u)
#define Response_Error_SIGNAL_HANDLE        (0x01u)
#define motor_data_SIGNAL_HANDLE        (0x02u)



#define motor_data_FLAG_HANDLE        (0x00u)
#define Frame1_FLAG_HANDLE        (0x01u)
#define Frame2_FLAG_HANDLE        (0x02u)
...
#define LIN_1_ISR_AUX_SET_FLAGS_Frame2_FLAG_MASK_0        (0x05u)
