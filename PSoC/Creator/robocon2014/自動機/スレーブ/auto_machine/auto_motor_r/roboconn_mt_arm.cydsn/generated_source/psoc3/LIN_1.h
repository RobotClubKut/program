...
#define LIN_1_NUM_SIGNALS           (0x03u)
#define LIN_1_NUM_UNIQUE_SIGNALS    (0x03u)
...
/* Constants for l_u8_rd_motor_data */
#define LIN_1_motor_data_Frame2_SIG_BYTE_OFFSET    (0x00u)

/* Constants for l_u8_wr_limit() */
#define LIN_1_limit_Frame3_SIG_BYTE_OFFSET    (0x00u)
#define LIN_1_limit_Frame3_SIG_MASK_0         (0x03u)


/* l_flg_tst_motor_data() and l_flg_clr_motor_data() */
#define LIN_1_motor_data_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_motor_data_FRAME_FLAG_MASK_0           (0x01u)

/* l_flg_tst_limit() and l_flg_clr_limit() */
#define LIN_1_limit_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_limit_FRAME_FLAG_MASK_0           (0x02u)

/* l_flg_tst_Frame1() and l_flg_clr_Frame1() */
#define LIN_1_Frame1_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame1_FRAME_FLAG_MASK_0           (0x04u)

/* l_flg_tst_Frame2() and l_flg_clr_Frame2() */
#define LIN_1_Frame2_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame2_FRAME_FLAG_MASK_0           (0x08u)

/* l_flg_tst_Frame3() and l_flg_clr_Frame3() */
#define LIN_1_Frame3_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame3_FRAME_FLAG_MASK_0           (0x10u)




#define Response_Error_SIGNAL_HANDLE        (0x00u)
#define motor_data_SIGNAL_HANDLE        (0x01u)
#define limit_SIGNAL_HANDLE        (0x02u)



#define motor_data_FLAG_HANDLE        (0x00u)
#define limit_FLAG_HANDLE        (0x01u)
#define Frame1_FLAG_HANDLE        (0x02u)
#define Frame2_FLAG_HANDLE        (0x03u)
#define Frame3_FLAG_HANDLE        (0x04u)



#define LIN_1_ISR_AUX_SET_FLAGS_Frame1_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame1_FLAG_MASK_0        (0x04u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame2_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame2_FLAG_MASK_0        (0x09u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame3_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame3_FLAG_MASK_0        (0x12u)
