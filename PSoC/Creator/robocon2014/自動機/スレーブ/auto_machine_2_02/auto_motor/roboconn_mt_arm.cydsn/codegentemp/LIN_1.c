...
static volatile l_u8  LIN_1_Buffer_Frame1[1u] = {0xFEu};
static volatile l_u8  LIN_1_Buffer_Frame2[2u] = {0x00u, 0x00u};
static volatile l_u8  LIN_1_Buffer_Frame3[1u] = {0xE0u};
...
l_u8 l_u8_rd(l_signal_handle sss) 
{
    ...
    switch(sss)
    {
        case motor_data_r_SIGNAL_HANDLE:
            returnValue = l_u8_rd_motor_data_r();
        break;

        case motor_data_l_SIGNAL_HANDLE:
            returnValue = l_u8_rd_motor_data_l();
        break;
...
/*******************************************************************************
* Function Name: l_u8_rd_motor_data_r
********************************************************************************
*
* Summary:
*  Reads and returns the current value of the signal for signals of the size
...
*
*******************************************************************************/
l_u8 l_u8_rd_motor_data_r(void) 
{
    /* Get one complete byte signal from frame */
    return(LIN_1_Buffer_Frame2[LIN_1_motor_data_r_Frame2_SIG_BYTE_OFFSET]);
}

/*******************************************************************************
* Function Name: l_u8_rd_motor_data_l
********************************************************************************
*
* Summary:
*  Reads and returns the current value of the signal for signals of the size
...
*
*******************************************************************************/
l_u8 l_u8_rd_motor_data_l(void) 
{
    /* Get one complete byte signal from frame */
    return(LIN_1_Buffer_Frame2[LIN_1_motor_data_l_Frame2_SIG_BYTE_OFFSET]);
}
...
void l_u8_wr(l_signal_handle sss, l_u8 v)
{
    switch(sss)
    {
        case limit_SIGNAL_HANDLE:
            l_u8_wr_limit(v);
        break;

        case status_SIGNAL_HANDLE:
            l_u8_wr_status(v);
        break;
...
void l_u8_wr_limit(l_u8 v)
{
    ...
    LIN_1_Buffer_Frame3[LIN_1_limit_Frame3_SIG_BYTE_OFFSET] &=
                  (l_u8) ~LIN_1_limit_Frame3_SIG_MASK_0;

    LIN_1_Buffer_Frame3[LIN_1_limit_Frame3_SIG_BYTE_OFFSET] |= v;
...
void l_u8_wr_status(l_u8 v)
{
    ...
    LIN_1_Buffer_Frame3[LIN_1_status_Frame3_SIG_BYTE_OFFSET] &= LIN_1_status_Frame3_SIG_MASK_0;

    /* And OR with shifted and masked value  */
    LIN_1_Buffer_Frame3[LIN_1_status_Frame3_SIG_BYTE_OFFSET] |= 
        ((l_u8) (v << LIN_1_status_Frame3_SIG_BIT_SHIFT));
...
l_bool l_flg_tst(l_flag_handle fff)
{
    ...
    switch(fff)
    {
        case motor_data_r_FLAG_HANDLE:
            returnValue = l_flg_tst_motor_data_r();
        break;

        case motor_data_l_FLAG_HANDLE:
            returnValue = l_flg_tst_motor_data_l();
        break;

        case limit_FLAG_HANDLE:
            returnValue = l_flg_tst_limit();
        break;

        case status_FLAG_HANDLE:
            returnValue = l_flg_tst_status();
        break;
...
/*******************************************************************************
* Function Name: l_flg_tst_motor_data_r
********************************************************************************
*
* Summary:
*  Returns a C boolean indicating the current state of the flag specified by
...
*
*******************************************************************************/
l_bool l_flg_tst_motor_data_r(void)
{
    l_bool result = LIN_1_FALSE;

    if(0u != (LIN_1_statusFlagArray[LIN_1_motor_data_r_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_motor_data_r_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
/*******************************************************************************
* Function Name: l_flg_tst_motor_data_l
********************************************************************************
*
* Summary:
*  Returns a C boolean indicating the current state of the flag specified by
...
*
*******************************************************************************/
l_bool l_flg_tst_motor_data_l(void)
{
    l_bool result = LIN_1_FALSE;

    if(0u != (LIN_1_statusFlagArray[LIN_1_motor_data_l_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_motor_data_l_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
*
*******************************************************************************/
l_bool l_flg_tst_limit(void)
{
    l_bool result = LIN_1_FALSE;

    if(0u != (LIN_1_statusFlagArray[LIN_1_limit_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_limit_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
/*******************************************************************************
* Function Name: l_flg_tst_status
********************************************************************************
*
* Summary:
*  Returns a C boolean indicating the current state of the flag specified by
...
*
*******************************************************************************/
l_bool l_flg_tst_status(void)
{
    l_bool result = LIN_1_FALSE;

    if(0u != (LIN_1_statusFlagArray[LIN_1_status_FRAME_FLAG_BYTE_OFFSET_0] &
    LIN_1_status_FRAME_FLAG_MASK_0))
    {
        result = LIN_1_TRUE;
    }
...
void l_flg_clr(l_flag_handle fff)
{
    ...
    {
        case motor_data_r_FLAG_HANDLE:
            l_flg_clr_motor_data_r();
        break;

        case motor_data_l_FLAG_HANDLE:
            l_flg_clr_motor_data_l();
        break;
...
/*******************************************************************************
* Function Name: l_flg_clr_motor_data_r
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
*
*******************************************************************************/
void l_flg_clr_motor_data_r(void)
{
    LIN_1_statusFlagArray[LIN_1_motor_data_r_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_motor_data_r_FRAME_FLAG_MASK_0);
}

/*******************************************************************************
* Function Name: l_flg_clr_motor_data_l
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
*
*******************************************************************************/
void l_flg_clr_motor_data_l(void)
{
    LIN_1_statusFlagArray[LIN_1_motor_data_l_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_motor_data_l_FRAME_FLAG_MASK_0);
}

/*******************************************************************************
* Function Name: l_flg_clr_limit
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
*
*******************************************************************************/
void l_flg_clr_limit(void)
{
    LIN_1_statusFlagArray[LIN_1_limit_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_limit_FRAME_FLAG_MASK_0);
}

/*******************************************************************************
* Function Name: l_flg_clr_status
********************************************************************************
*
* Summary:
*  Sets the current value of the flag specified by the name fff to zero.
...
*
*******************************************************************************/
void l_flg_clr_status(void)
{
    LIN_1_statusFlagArray[LIN_1_status_FRAME_FLAG_BYTE_OFFSET_0] &=
       ((l_u8) ~LIN_1_status_FRAME_FLAG_MASK_0);
}
    ...
    static LIN_1_PID_INFO_TABLE const CYCODE LIN_1_pidInfoTable[LIN_1_NUM_FRAMES] =
{
    ...
    {(LIN_1_FRAME_DIR_SUBSCRIBE | LIN_1_FRAME_DATA_SIZE_2 | LIN_1_FRAME_TYPE_UNCOND),
     LIN_1_Buffer_Frame2}, 
