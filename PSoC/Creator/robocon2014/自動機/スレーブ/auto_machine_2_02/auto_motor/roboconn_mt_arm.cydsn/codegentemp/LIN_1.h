...
#define LIN_1_NUM_FRAMES            (0x03u)
#define LIN_1_NUM_ET_FRAMES         (0x00u)
#define LIN_1_NUM_SIGNALS           (0x05u)
#define LIN_1_NUM_UNIQUE_SIGNALS    (0x05u)
...
#define LIN_1_Response_Error_Frame1_SIG_BIT_OFFSET     (0x00u)
#define LIN_1_Response_Error_Frame1_SIG_MASK_0         (0x01u)

/* Constants for l_u8_rd_motor_data_r */
#define LIN_1_motor_data_r_Frame2_SIG_BYTE_OFFSET    (0x00u)

/* Constants for l_u8_rd_motor_data_l */
#define LIN_1_motor_data_l_Frame2_SIG_BYTE_OFFSET    (0x01u)

/* Constants for l_u8_wr_limit() */
#define LIN_1_limit_Frame3_SIG_BYTE_OFFSET    (0x00u)
#define LIN_1_limit_Frame3_SIG_MASK_0         (0x07u)

/* Constants for l_u8_wr_status() */
#define LIN_1_status_Frame3_SIG_BYTE_OFFSET    (0x00u)
#define LIN_1_status_Frame3_SIG_BIT_SHIFT      (0x03u)
#define LIN_1_status_Frame3_SIG_MASK_0         (0xE7u)


/* l_flg_tst_motor_data_r() and l_flg_clr_motor_data_r() */
#define LIN_1_motor_data_r_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_motor_data_r_FRAME_FLAG_MASK_0           (0x01u)

/* l_flg_tst_motor_data_l() and l_flg_clr_motor_data_l() */
#define LIN_1_motor_data_l_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_motor_data_l_FRAME_FLAG_MASK_0           (0x02u)

/* l_flg_tst_limit() and l_flg_clr_limit() */
#define LIN_1_limit_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_limit_FRAME_FLAG_MASK_0           (0x04u)

/* l_flg_tst_status() and l_flg_clr_status() */
#define LIN_1_status_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_status_FRAME_FLAG_MASK_0           (0x08u)

/* l_flg_tst_Frame1() and l_flg_clr_Frame1() */
#define LIN_1_Frame1_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame1_FRAME_FLAG_MASK_0           (0x10u)

/* l_flg_tst_Frame2() and l_flg_clr_Frame2() */
#define LIN_1_Frame2_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame2_FRAME_FLAG_MASK_0           (0x20u)

/* l_flg_tst_Frame3() and l_flg_clr_Frame3() */
#define LIN_1_Frame3_FRAME_FLAG_BYTE_OFFSET_0    (0x00u)
#define LIN_1_Frame3_FRAME_FLAG_MASK_0           (0x40u)




#define Response_Error_SIGNAL_HANDLE        (0x00u)
#define motor_data_r_SIGNAL_HANDLE        (0x01u)
#define motor_data_l_SIGNAL_HANDLE        (0x02u)
#define limit_SIGNAL_HANDLE        (0x03u)
#define status_SIGNAL_HANDLE        (0x04u)



#define motor_data_r_FLAG_HANDLE        (0x00u)
#define motor_data_l_FLAG_HANDLE        (0x01u)
#define limit_FLAG_HANDLE        (0x02u)
#define status_FLAG_HANDLE        (0x03u)
#define Frame1_FLAG_HANDLE        (0x04u)
#define Frame2_FLAG_HANDLE        (0x05u)
#define Frame3_FLAG_HANDLE        (0x06u)



#define LIN_1_ISR_AUX_SET_FLAGS_Frame1_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame1_FLAG_MASK_0        (0x10u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame2_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame2_FLAG_MASK_0        (0x23u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame3_FLAG_BYTE_OFFSET_0        (0x00u)
#define LIN_1_ISR_AUX_SET_FLAGS_Frame3_FLAG_MASK_0        (0x4Cu)
