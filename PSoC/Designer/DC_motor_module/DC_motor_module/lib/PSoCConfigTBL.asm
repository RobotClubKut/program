...
export LoadConfigTBL_dc_motor_module_Bank1
export LoadConfigTBL_dc_motor_module_Bank0
export LoadConfigTBL_dc_motor_module_Ordered
AREA lit(rom, rel)
LoadConfigTBL_dc_motor_module_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_dc_motor_module_Bank1:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name MBM_1, User Module MBM
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	db		20h, 39h		;PWM8_1_FUNC_REG(DBB00FN)
	db		21h, 16h		;PWM8_1_INPUT_REG(DBB00IN)
	db		22h, 44h		;PWM8_1_OUTPUT_REG(DBB00OU)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DBB01)
	db		24h, 39h		;PWM8_2_FUNC_REG(DBB01FN)
	db		25h, 16h		;PWM8_2_INPUT_REG(DBB01IN)
	db		26h, 45h		;PWM8_2_OUTPUT_REG(DBB01OU)
;  Instance name PWM8_3, User Module PWM8
;       Instance name PWM8_3, Block Name PWM8(DCB02)
	db		28h, 39h		;PWM8_3_FUNC_REG(DCB02FN)
	db		29h, 16h		;PWM8_3_INPUT_REG(DCB02IN)
	db		2ah, 46h		;PWM8_3_OUTPUT_REG(DCB02OU)
;  Instance name PWM8_4, User Module PWM8
;       Instance name PWM8_4, Block Name PWM8(DCB03)
	db		2ch, 39h		;PWM8_4_FUNC_REG(DCB03FN)
	db		2dh, 16h		;PWM8_4_INPUT_REG(DCB03IN)
	db		2eh, 47h		;PWM8_4_OUTPUT_REG(DCB03OU)
;  Instance name PWM8_5, User Module PWM8
;       Instance name PWM8_5, Block Name PWM8(DBB10)
	db		30h, 39h		;PWM8_5_FUNC_REG(DBB10FN)
	db		31h, 16h		;PWM8_5_INPUT_REG(DBB10IN)
	db		32h, 44h		;PWM8_5_OUTPUT_REG(DBB10OU)
;  Instance name PWM8_6, User Module PWM8
;       Instance name PWM8_6, Block Name PWM8(DBB11)
	db		34h, 39h		;PWM8_6_FUNC_REG(DBB11FN)
	db		35h, 16h		;PWM8_6_INPUT_REG(DBB11IN)
...
LoadConfigTBL_dc_motor_module_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], f8h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], a7h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
