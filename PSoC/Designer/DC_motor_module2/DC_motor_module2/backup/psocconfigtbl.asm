...
export LoadConfigTBL_dc_motor_module2_Bank1
export LoadConfigTBL_dc_motor_module2_Bank0
export LoadConfigTBL_dc_motor_module2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_dc_motor_module2_Bank0:
...
;       Instance name PWM8_3, Block Name PWM8(DCB02)
	db		2bh, 00h		;PWM8_3_CONTROL_REG(DCB02CR0)
	db		29h, ffh		;PWM8_3_PERIOD_REG(DCB02DR1)
	db		2ah, 00h		;PWM8_3_COMPARE_REG(DCB02DR2)
;  Instance name PWM8_4, User Module PWM8
;       Instance name PWM8_4, Block Name PWM8(DCB03)
	db		2fh, 00h		;PWM8_4_CONTROL_REG(DCB03CR0)
	db		2dh, ffh		;PWM8_4_PERIOD_REG(DCB03DR1)
	db		2eh, 00h		;PWM8_4_COMPARE_REG(DCB03DR2)
;  Instance name PWM8_5, User Module PWM8
;       Instance name PWM8_5, Block Name PWM8(DBB10)
	db		33h, 00h		;PWM8_5_CONTROL_REG(DBB10CR0)
	db		31h, ffh		;PWM8_5_PERIOD_REG(DBB10DR1)
	db		32h, 00h		;PWM8_5_COMPARE_REG(DBB10DR2)
;  Instance name PWM8_6, User Module PWM8
;       Instance name PWM8_6, Block Name PWM8(DBB11)
	db		37h, 00h		;PWM8_6_CONTROL_REG(DBB11CR0)
	db		35h, ffh		;PWM8_6_PERIOD_REG(DBB11DR1)
	db		36h, 00h		;PWM8_6_COMPARE_REG(DBB11DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_dc_motor_module2_Bank1:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	db		20h, 29h		;PWM8_1_FUNC_REG(DBB00FN)
	db		21h, 15h		;PWM8_1_INPUT_REG(DBB00IN)
	db		22h, 44h		;PWM8_1_OUTPUT_REG(DBB00OU)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DBB01)
	db		24h, 29h		;PWM8_2_FUNC_REG(DBB01FN)
	db		25h, 15h		;PWM8_2_INPUT_REG(DBB01IN)
	db		26h, 45h		;PWM8_2_OUTPUT_REG(DBB01OU)
;  Instance name PWM8_3, User Module PWM8
;       Instance name PWM8_3, Block Name PWM8(DCB02)
	db		28h, 29h		;PWM8_3_FUNC_REG(DCB02FN)
	db		29h, 15h		;PWM8_3_INPUT_REG(DCB02IN)
	db		2ah, 46h		;PWM8_3_OUTPUT_REG(DCB02OU)
;  Instance name PWM8_4, User Module PWM8
;       Instance name PWM8_4, Block Name PWM8(DCB03)
	db		2ch, 29h		;PWM8_4_FUNC_REG(DCB03FN)
	db		2dh, 15h		;PWM8_4_INPUT_REG(DCB03IN)
	db		2eh, 47h		;PWM8_4_OUTPUT_REG(DCB03OU)
;  Instance name PWM8_5, User Module PWM8
;       Instance name PWM8_5, Block Name PWM8(DBB10)
	db		30h, 29h		;PWM8_5_FUNC_REG(DBB10FN)
	db		31h, 15h		;PWM8_5_INPUT_REG(DBB10IN)
	db		32h, 44h		;PWM8_5_OUTPUT_REG(DBB10OU)
;  Instance name PWM8_6, User Module PWM8
;       Instance name PWM8_6, Block Name PWM8(DBB11)
	db		34h, 29h		;PWM8_6_FUNC_REG(DBB11FN)
	db		35h, 15h		;PWM8_6_INPUT_REG(DBB11IN)
	db		36h, 45h		;PWM8_6_OUTPUT_REG(DBB11OU)
...
LoadConfigTBL_dc_motor_module2_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 3fh		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], c0h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], c0h		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 3fh		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
	...
	M8C_SetBank1
	mov	reg[04h], e8h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], b7h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], b7h		; Port_1_DriveMode_2 register (PRT1DM2)
	...
	M8C_SetBank1
	mov	reg[08h], a3h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 5ch		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 5ch		; Port_2_DriveMode_2 register (PRT2DM2)
