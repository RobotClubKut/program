...
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	...
	db		22h, 05h		;PWM8_1_COMPARE_REG(DBB00DR2)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], 87h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 78h		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 78h		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], 07h		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
