...
export LoadConfig_dc_motor_module
export _LoadConfig_dc_motor_module
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_dc_motor_module
	lcall	LoadConfigTBL_dc_motor_module_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration dc_motor_module
;
;    Load configuration registers for dc_motor_module.
...
;               CUR_PP
;
_LoadConfig_dc_motor_module:
 LoadConfig_dc_motor_module:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_dc_motor_module_Bank0
    mov     X, <LoadConfigTBL_dc_motor_module_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_dc_motor_module_Bank1
    mov     X, <LoadConfigTBL_dc_motor_module_Bank1
