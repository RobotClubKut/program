...
export LoadConfig_i2c_test0
export _LoadConfig_i2c_test0
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_i2c_test0
	lcall	LoadConfigTBL_i2c_test0_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration i2c_test0
;
;    Load configuration registers for i2c_test0.
...
;               CUR_PP
;
_LoadConfig_i2c_test0:
 LoadConfig_i2c_test0:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_i2c_test0_Bank0
    mov     X, <LoadConfigTBL_i2c_test0_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_i2c_test0_Bank1
    mov     X, <LoadConfigTBL_i2c_test0_Bank1
