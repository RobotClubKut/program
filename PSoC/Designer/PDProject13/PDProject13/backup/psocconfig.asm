...
export LoadConfig_pdproject13
export _LoadConfig_pdproject13
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pdproject13
	lcall	LoadConfigTBL_pdproject13_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pdproject13
;
;    Load configuration registers for pdproject13.
...
;               CUR_PP
;
_LoadConfig_pdproject13:
 LoadConfig_pdproject13:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pdproject13_Bank0
    mov     X, <LoadConfigTBL_pdproject13_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pdproject13_Bank1
    mov     X, <LoadConfigTBL_pdproject13_Bank1
