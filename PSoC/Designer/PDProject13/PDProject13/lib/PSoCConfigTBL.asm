...
export LoadConfigTBL_pdproject13_Bank1
export LoadConfigTBL_pdproject13_Bank0
export LoadConfigTBL_pdproject13_Ordered
AREA lit(rom, rel)
LoadConfigTBL_pdproject13_Bank0:
;  Instance name ADCINC_1, User Module ADCINC
;       Instance name ADCINC_1, Block Name ADC(ASC10)
	db		80h, 90h		;ADCINC_1_AtoDcr0(ASC10CR0)
	db		81h, e0h		;ADCINC_1_AtoDcr1(ASC10CR1)
	db		82h, 60h		;ADCINC_1_AtoDcr2(ASC10CR2)
	db		83h, f8h		;ADCINC_1_AtoDcr3(ASC10CR3)
...
;       Instance name PWM8_1, Block Name PWM8(DBB01)
	db		27h, 00h		;PWM8_1_CONTROL_REG(DBB01CR0)
	db		25h, ffh		;PWM8_1_PERIOD_REG(DBB01DR1)
	db		26h, 00h		;PWM8_1_COMPARE_REG(DBB01DR2)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DCB02)
	db		2bh, 00h		;PWM8_2_CONTROL_REG(DCB02CR0)
	db		29h, ffh		;PWM8_2_PERIOD_REG(DCB02DR1)
	db		2ah, 00h		;PWM8_2_COMPARE_REG(DCB02DR2)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_pdproject13_Bank1:
;  Instance name ADCINC_1, User Module ADCINC
;       Instance name ADCINC_1, Block Name ADC(ASC10)
;       Instance name ADCINC_1, Block Name PWM(DBB00)
...
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB01)
	db		24h, 29h		;PWM8_1_FUNC_REG(DBB01FN)
	db		25h, 16h		;PWM8_1_INPUT_REG(DBB01IN)
	db		26h, 44h		;PWM8_1_OUTPUT_REG(DBB01OU)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DCB02)
	db		28h, 29h		;PWM8_2_FUNC_REG(DCB02FN)
	db		29h, 16h		;PWM8_2_INPUT_REG(DCB02IN)
	db		2ah, 45h		;PWM8_2_OUTPUT_REG(DCB02OU)
;  Instance name SleepTimer_1, User Module SleepTimer
;  Global Register values Bank 1
	...
	db		e1h, f1h		; OscillatorControl_1 register (OSC_CR1)
...
LoadConfigTBL_pdproject13_Ordered:
;  Ordered Global Register values
	...
	mov	reg[09h], ebh		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], ebh		; Port_2_DriveMode_2 register (PRT2DM2)
