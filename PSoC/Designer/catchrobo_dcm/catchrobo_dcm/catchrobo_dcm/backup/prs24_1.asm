...
;  Global Symbols
;-----------------------------------------------
export    PRS24_1_Start
export   _PRS24_1_Start
export    PRS24_1_Stop
export   _PRS24_1_Stop
export    PRS24_1_WriteSeed
export   _PRS24_1_WriteSeed
export    PRS24_1_WritePolynomial
export   _PRS24_1_WritePolynomial
export    PRS24_1_ReadPRS
export   _PRS24_1_ReadPRS
...
_PRS24_1_Start:
   ...
   or    REG[PRS24_1_CONTROL_REG_LSB], bfCONTROL_REG_START_BIT
...
_PRS24_1_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[PRS24_1_CONTROL_REG_LSB], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PRS24_1_WriteSeed
;
;  DESCRIPTION:
...
_PRS24_1_WriteSeed:
 PRS24_1_WriteSeed:
   ...
   mov   A, REG[PRS24_1_CONTROL_REG_LSB]
   push  A
   ...
   mov   A, [X-5]
   mov   reg[PRS24_1_SEED_REG_MSB], A
   mov   A, [X-4]
   mov   reg[PRS24_1_SEED_REG_ISB], A
   mov   A, [X-3]
   mov   reg[PRS24_1_SEED_REG_LSB], A

   ; restore the start state
   pop   A
   mov   REG[PRS24_1_CONTROL_REG_LSB], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PRS24_1_WritePolynomial
;
;  DESCRIPTION:
...
;
;-----------------------------------------------------------------------------
_PRS24_1_WritePolynomial:
 PRS24_1_WritePolynomial:
   RAM_PROLOGUE RAM_USE_CLASS_2
   mov   X, SP
   ...
   mov   A, [X-5]
   mov   reg[PRS24_1_POLY_REG_MSB], A
   mov   A, [X-4]
   mov   reg[PRS24_1_POLY_REG_ISB], A
   mov   A, [X-3]
   mov   reg[PRS24_1_POLY_REG_LSB], A
...
_PRS24_1_ReadPRS:
   ...
   mov   A, reg[PRS24_1_SHIFT_REG_MSB]

   ; Read the PRS computed value
   mov   A, reg[PRS24_1_SEED_REG_MSB]
   mov   [X+1], A
   ...
   ; Read the Shift register.  This causes the current
   ;  PRS computed number to be transferred to the Seed register.
   mov   A, reg[PRS24_1_SHIFT_REG_ISB]

   ; Read the PRS computed value
   mov   A, reg[PRS24_1_SEED_REG_ISB]
   mov   [X+2], A
   ...
   ; Read the Shift register.  This causes the current
   ;  PRS computed number to be transferred to the Seed register.
   mov   A, reg[PRS24_1_SHIFT_REG_LSB]

   ; Read the PRS computed value
   mov   A, reg[PRS24_1_SEED_REG_LSB]
   mov   [X+3], A
