...
export LoadConfig_catchrobo_dcm2
export _LoadConfig_catchrobo_dcm2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_catchrobo_dcm2
	lcall	LoadConfigTBL_catchrobo_dcm2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration catchrobo_dcm2
;
;    Load configuration registers for catchrobo_dcm2.
...
;               CUR_PP
;
_LoadConfig_catchrobo_dcm2:
 LoadConfig_catchrobo_dcm2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_catchrobo_dcm2_Bank0
    mov     X, <LoadConfigTBL_catchrobo_dcm2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_catchrobo_dcm2_Bank1
    mov     X, <LoadConfigTBL_catchrobo_dcm2_Bank1
