...
export LoadConfig_ira2kai
export _LoadConfig_ira2kai
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_ira2kai
	lcall	LoadConfigTBL_ira2kai_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration ira2kai
;
;    Load configuration registers for ira2kai.
...
_LoadConfig_ira2kai:
 LoadConfig_ira2kai:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_ira2kai_Bank0
    mov     X, <LoadConfigTBL_ira2kai_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_ira2kai_Bank1
    mov     X, <LoadConfigTBL_ira2kai_Bank1
