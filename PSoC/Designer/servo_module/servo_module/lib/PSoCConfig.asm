...
export LoadConfig_servo_module
export _LoadConfig_servo_module
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_servo_module
	lcall	LoadConfigTBL_servo_module_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration servo_module
;
;    Load configuration registers for servo_module.
...
;               CUR_PP
;
_LoadConfig_servo_module:
 LoadConfig_servo_module:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_servo_module_Bank0
    mov     X, <LoadConfigTBL_servo_module_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_servo_module_Bank1
    mov     X, <LoadConfigTBL_servo_module_Bank1
