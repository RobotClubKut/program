...
export LoadConfig_stepping_test
export _LoadConfig_stepping_test
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_stepping_test
	lcall	LoadConfigTBL_stepping_test_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration stepping_test
;
;    Load configuration registers for stepping_test.
...
;               CUR_PP
;
_LoadConfig_stepping_test:
 LoadConfig_stepping_test:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_stepping_test_Bank0
    mov     X, <LoadConfigTBL_stepping_test_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_stepping_test_Bank1
    mov     X, <LoadConfigTBL_stepping_test_Bank1
