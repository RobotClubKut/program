...
export LoadConfig_sv4
export _LoadConfig_sv4
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_sv4
	lcall	LoadConfigTBL_sv4_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration sv4
;
;    Load configuration registers for sv4.
...
_LoadConfig_sv4:
 LoadConfig_sv4:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_sv4_Bank0
    mov     X, <LoadConfigTBL_sv4_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_sv4_Bank1
    mov     X, <LoadConfigTBL_sv4_Bank1
